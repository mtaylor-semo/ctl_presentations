...
\vfilll
\tiny \href{https://commons.wikimedia.org/wiki/File:Connect_the_dots_puzzle.jpg}{Whitney Waller, Wikimedia, \ccbysa{2.0}}
\end{frame}
}
...
\begin{frame}[t,plain]
\vfilll
\tiny \href{https://commons.wikimedia.org/wiki/File:Connect_the_dots_puzzle.jpg}{Whitney Waller, Wikimedia, \ccbysa{2.0}} \hfill Solved by Mike.
\end{frame}
}
...
\begin{frame}
\vfilll
\tiny \textcolor{black!30!white}{\href{https://www.flickr.com/photos/31767752@N08/2967148200}{jul13d0wn3s, Flickr, \ccby{2.0}}}
...
%
{
\usebackgroundtemplate{\scalebox{-1}[1]{\includegraphics[width=\paperwidth]{marine_snow}}}

\begin{frame}[t]{\textcolor{white}{Consider what you know about marine snow.}}

\hangpara \textcolor{white}{How do you think the vertical distribution of nutrients from the surface downward affects the vertical distribution of biomass and density of individuals?}

\tinyfill\textcolor{white}{\href{https://oceanexplorer.noaa.gov/okeanos/explorations/ex1104/logs/aug8/welcome.html}{NOAA Okeanos Explorer Program, Mid-Cayman Rise Expedition 2011, Public Domain}}
\end{frame}
}
